...
module.exports = {
    entry: {
        worker: './node_modules/json-midi-encoder-worker/build/es2019/module.js'
    },
    mode: 'production',
    module: {
        rules: [
                            ...
                            for (const chunk of compilation.chunks) {
                                for (const file of chunk.files) {
                                    compilation.updateAsset(file, (asset) => {
                                        ...
                                        return new RawSource(`// This is the minified and stringified code of the json-midi-encoder-worker package.
